"""
test file for main.py -- integrates prs and issues into consolidated report
"""
import logging
...
def test_main():
    ...
    #    [29653, 29664], developer_ids, start_date, end_date
    # )

    pr_raw_results = get_prs_from_date_range(
        pull_requests_all, developer_ids, start_date, end_date
    )

    pr_sorted_results = sort_final_data(pr_raw_results[0])
